...
function KandangTable({ kandangData, onEdit, onDelete, darkMode, canEdit, canDelete }) {
  return (
    <div
      className={`
              ...
              kandangData.map((item, index) => (
                ...
                >
                  ...
                  <td className={`p-3 sm:p-4 ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
                    {item.kapasitas} <span className="text-xs">Ekor</span>
                  </td>
