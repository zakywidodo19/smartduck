...
function Laporan() {
  ...
  useEffect(() => {
    const fetchLaporan = async () => {
      ...
      setLaporanData(
        kandang.map((k) => {
          const produksiBulanIni = produksi
            .filter((p) => {
      ...
      setSummary({ totalPendapatan, totalPengeluaran });
    };
    fetchLaporan();
  }, []);
        ...
        <div className="print-section">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 sm:mb-8">
            <StatCard
              ...
              darkMode={darkMode}
              icon={<FaEgg className="text-emerald-500" />}
              subtitle="Pendapatan dari telur bulan ini"
            />
            <StatCard
              ...
              subtitle="Pengeluaran pakan bulan ini"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {/* TOTAL PRODUKSI */}
            <div
              className={`rounded-2xl p-5 shadow-md border ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100 print:border-gray-300"}`}
            >
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  >
                    Tersebar di {kandangData.length} Kandang
                  </p>
                </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h1 className={`text-2xl font-bold mt-1 text-green-500`}>
                    0%
                  </h1>
                  <p
                    className={`text-xs mt-1 ${darkMode ? "text-gray-400" : "text-gray-500"}`}
          ...
          {/* TABLE LAPORAN */}
          <div
            className={`rounded-2xl shadow-md border mb-6 sm:mb-8 ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-100 print:border-gray-300 print:shadow-none"}`}
          >
            <div
              className={`p-4 sm:p-6 border-b ${darkMode ? "border-gray-700" : "border-gray-100 print:border-gray-300"}`}
            >
              <h2
                className={`text-lg font-semibold ${darkMode ? "text-white" : "text-gray-800 print:text-black"}`}
              >
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[700px]">
                <thead>
                  <tr
                    className={`text-left text-xs uppercase tracking-wider ${darkMode ? "bg-gray-750 text-gray-400" : "bg-gray-50 text-gray-500 print:bg-white print:text-gray-700"}`}
                  >
                ...
                <tbody>
                  {laporanData.map((item, index) => (
                    ...
                    >
                      ...
                      <td
                        className={`p-4 text-center ${darkMode ? "text-gray-300" : "text-gray-600 print:text-black"}`}
                      >
                        {item.populasi}
                      </td>
                      <td
                        className={`p-4 text-center font-bold ${darkMode ? "text-gray-200" : "text-gray-700 print:text-black"}`}
                      >
                        {item.produksi}
                      </td>
                      <td
                        className={`p-4 ${darkMode ? "text-gray-300" : "text-gray-600 print:text-black"}`}
                      >
                        {item.pakan}
                      </td>
                      <td className="p-4">
                        <span
                          ...
                          ${
                            item.kesehatan === "Sehat"
                              ? darkMode
                                ? "bg-green-900/30 text-green-400 border-green-800 print:bg-transparent print:text-green-700 print:border-none"
                                : "bg-green-100 text-green-700 border-green-200"
                              : darkMode
                                ? "bg-yellow-900/30 text-yellow-400 border-yellow-800 print:bg-transparent print:text-yellow-700 print:border-none"
                        ...
                        <span
                          ...
                          ${
                            item.status === "Optimal"
                              ...
                              : item.status === "Stabil"
                                ? darkMode
                                  ? "bg-blue-900/30 text-blue-400 border-blue-800 print:bg-transparent print:text-blue-700 print:border-none"
                                  : "bg-blue-100 text-blue-700 border-blue-200"
                                : darkMode
                                  ? "bg-red-900/30 text-red-400 border-red-800 print:bg-transparent print:text-red-700 print:border-none"
              ...
              {laporanData.length === 0 && (
                <div
                  className={`text-center p-6 ${darkMode ? "text-gray-400" : "text-gray-500"}`}
                >
